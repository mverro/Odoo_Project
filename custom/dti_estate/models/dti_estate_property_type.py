...
class DtiEstatePropertyType(models.Model):

    # ---------------------------------------- Private Attributes ---------------------------------

    _name = "dti.estate.property.type"
    ...
    property_ids = fields.One2many("dti.estate.property", "property_type_id", string="Properties")

    # Computed (for stat button)
    offer_count = fields.Integer(string="Offers Count", compute="_compute_offer")
    offer_ids = fields.Many2many("dti.estate.property.offer", string="Offers", compute="_compute_offer")
    ...
    def _compute_offer(self):
        ...
        # a loop.
        data = self.env["dti.estate.property.offer"].read_group(
    ...
    def action_view_offers(self):
        res = self.env.ref("dti_estate.estate_property_offer_action").read()[0]
