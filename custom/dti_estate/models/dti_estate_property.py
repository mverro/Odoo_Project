...
class DtiEstateProperty(models.Model):

    # ---------------------------------------- Private Attributes ---------------------------------

    _name = "dti.estate.property"
    ...
    tag_ids = fields.Many2many("dti.estate.property.tag", string="Tags")
    offer_ids = fields.One2many("dti.estate.property.offer", "property_id", string="Offers")
